<template lang="pug">
  div
    header.home.header
      ...
      div.foreground
        div.page-bar.wrapper
          a.person-name(href="/") {{ person.fields.name }}
          Navigation
        div.page-info.wrapper
          h2 {{ person.fields.title }}
          p {{ person.fields.shortBio }}
          ul.social-icons
            li(v-if='person.fields.facebook')
              a(
                :href="person.fields.facebook"
                :aria-label="`${ person.fields.name } on Facebook`"
              )
                svg(
            ...
            li(v-if='person.fields.twitter')
              a(
                ...
                :aria-label="`${ person.fields.name } on Twitter`"
              )
                svg(
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 100 100"
            ...
            li(v-if='person.fields.github')
              a(
                ...
                :aria-label="`${ person.fields.name } on Github`"
              )
    ...
    section.body-container
      div.items-bar.wrapper
        h2 Recent articles
      ul.items-list.wrapper
